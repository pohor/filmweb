...
class OriginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create origin" do
    assert_difference('Origin.count') do
      post origins_url, params: { origin: { description: @origin.description, name: @origin.name } }
    end
  ...
  test "should update origin" do
    patch origin_url(@origin), params: { origin: { description: @origin.description, name: @origin.name } }
